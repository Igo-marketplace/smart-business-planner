...
const appCss = "/assets/styles-DkkOYrd1.css";
...
const $$splitComponentImporter$6 = () => import("./wizard-DzEE6dyS.js");
const Route$6 = createFileRoute("/wizard")({
  head: () => ({
    meta: [{
      title: "Создание бизнес-плана — Smart Business Planner"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./results-BrtYTw05.js");
const Route$5 = createFileRoute("/results")({
  head: () => ({
    meta: [{
      title: "Готовый план — Smart Business Planner"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./profile-RjxBqtYB.js");
const Route$4 = createFileRoute("/profile")({
  head: () => ({
    meta: [{
      title: "API-ключи — Smart Business Planner"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./pricing-CipapVya.js");
const Route$3 = createFileRoute("/pricing")({
  head: () => ({
    meta: [{
      title: "Тарифы — Smart Business Planner"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./plans-BqYNU0-p.js");
const Route$2 = createFileRoute("/plans")({
  head: () => ({
    meta: [{
      title: "Мои планы — Smart Business Planner"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./generate-CyuaWqXA.js");
const Route$1 = createFileRoute("/generate")({
  head: () => ({
    meta: [{
      title: "Генерация — Smart Business Planner"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-Dm5CSOsG.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AI-бизнес-план для малого и среднего бизнеса за 15 минут. С учётом налогов РФ, отраслей и реальной аналитики."
    }, {
      property: "og:title",
      content: "Smart Business Planner — AI бизнес-план для МСП"
    }, {
      property: "og:description",
      content: "Готовый бизнес-план для банка, инвестора или гранта."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const WizardRoute = Route$6.update({
  id: "/wizard",
  path: "/wizard",
  getParentRoute: () => Route$7
});
const ResultsRoute = Route$5.update({
  id: "/results",
  path: "/results",
  getParentRoute: () => Route$7
});
...
const PlansRoute = Route$2.update({
  id: "/plans",
  path: "/plans",
  getParentRoute: () => Route$7
});
const GenerateRoute = Route$1.update({
  id: "/generate",
  path: "/generate",
  getParentRoute: () => Route$7
});
